...
DECLARE_UNIQUE_INDEX(pg_extension_feature_name_index, 3181, on pg_extension_feature using btree(extfeature name_ops));
#define ExtensionFeatureNameIndexId 3181

DECLARE_INDEX(pg_extension_feature_extoid_name_index, 3182, on pg_extension_feature using btree(extoid oid_ops, extfeature name_ops));
#define ExtensionFeatureExtensionNameIndexId 3182
