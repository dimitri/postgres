...
extern void RenameTableSpace(const char *oldname, const char *newname, CommandContext cmd);
extern void AlterTableSpaceOwner(const char *name, Oid newOwnerId, CommandContext cmd);
