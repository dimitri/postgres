...
extern bool ExecBeforeOrInsteadOfCommandTriggers();
extern bool ExecBeforeOrInsteadOfAnyCommandTriggers();
extern void ExecAfterCommandTriggers();
extern void ExecAfterAnyCommandTriggers();
